...
export class TabItem extends Component {
    ...
    /**
     * Deze methode behandelt het klikken van een tabItem en zorgt ervoor dat er een pageHit verstuurd wordt naar Google Analytics
     */
    handlePress = () => {
        ExpoAnalyticsManager.getAnalytics().pageHit(this.props.routeName);
