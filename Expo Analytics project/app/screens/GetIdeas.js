...
export default class GetIdeas extends Component {
    ...
    updateRecipes = (recipeIndex) => {
        ...
        ExpoAnalyticsManager.getAnalytics({dp:"/Get Ideas", dt:"Get Ideas"}).event("Like","Like-" + recipes[recipeIndex].name.replace(/\s+/g, '-'), recipes[recipeIndex].name, 1);
    ...
    /**
     * Deze methode zal aangeroepen worden nadat het scherm geladen is
     */
    componentDidMount(){
